(function($, window, document, undefined) {
  "use strict";
  Drupal.behaviors.mabel_page__object = {
    attach: function(context, settings) {
      ...
      /* Add button styles to islandora navigation links */      $("#islandora-solr-search-return-link a").addClass("green button");
      ...
      /* Move transcript link to above PDF */      var $transcript_link = $('.tabs-primary__tab-link:contains("Transcript")');
