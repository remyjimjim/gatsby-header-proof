(function($, window, document, undefined) {
  "use strict";
  Drupal.behaviors.email_signature = {
    attach: function(context, settings) {
      ...
      if (generateButton) {
        generateButton.onclick = function() {
          ...
          if (phone_one) {
            document.getElementById("field_phone_one").innerHTML = ' | <a href="tel:' + phone_one + '">' + phone_one + "</a>";
          } else {
            document.getElementById("field_phone_one").innerHTML = "";
          }
          if (phone_two) {
            document.getElementById("field_phone_two").innerHTML = ' | <a href="tel:' + phone_two + '">' + phone_two + "</a>";
          } else {
            document.getElementById("field_phone_two").innerHTML = "";
          }
          if (mail_stop) {
            document.getElementById("field_mail_stop").innerText = " | " + mail_stop;
          } else {
            document.getElementById("field_mail_stop").innerText = "";
          }
          if (department_website) {
            document.getElementById("field_department").innerHTML = '<a href="' + department_website + '">' + department + "</a>";
          }
