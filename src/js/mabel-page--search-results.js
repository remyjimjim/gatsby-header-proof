(function($, window, document, undefined) {
  "use strict";
  Drupal.behaviors.mabel_page__search_results = {
    attach: function(context, settings) {
      ...
      /* Move search results count to after skip link */      var $search_count = $("#islandora-solr-result-count");
      $(".pane-page-title").append($search_count);
      /* Move results limits and display options after search count */      var $results_limit = $(".pane-islandora-solr-result-limit");
      ...
      /* Make result and display pane titles into expand buttons */      var $pane_titles = $(".pane-islandora-solr-result-limit .pane-title, .pane-islandora-solr-display-switch .pane-title");
      ...
      /* Move the sort options to just above search results */      var $sort = $(".pane-islandora-solr-sort");
      $(".layout__region--second").prepend($sort);
      /* Adjust title */      $(".pane-islandora-solr-sort .pane-title").text("Sort by:");
      /* Replace asc/desc images with html & css */      $('img[title="sort ascending"]').replaceWith('<span class="sort-asc material-icons" aria-hidden="true">play_arrow</span>');
