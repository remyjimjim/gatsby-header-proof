...
<div className={styles.westernHeader}>
  <div className={styles.wrap}>
    <div className={styles.westernLogo}>
      <a className={styles.westernHomeLink} href="https://wwu.edu">
      <div className={styles.logo}>
        <span className={styles.visuallyHidden}>Western Washington University</span>
    ...
    <button className={[styles.toggle, styles.toggleMenu].join(' ')}><span className={styles.materialIcons} aria-hidden="true">menu</span><span className={styles.buttonText + ' ' + styles.visuallyHidden}>Open the menu</span></button>
    <nav className={[styles.quickLinks,styles.desktop].join(' ')} aria-label="Western Quick Links">
    ...
    <div className={styles.search} role="search" aria-label="Western">
        <button className={styles.toggle + ' ' + styles.toggleSearch}><span className={styles.materialIcons} aria-hidden="true">search</span><span className={styles.buttonText + ' ' + styles.visuallyHidden}>Open the search box</span></button>
        <form className={styles.searchArea} method="get" action="https://search2.wwu.edu/texis/search">
          <div className={styles.searchBox}>
            <input id="search-box" placeholder="Search this site" name="query"></input>
            <label for="search-box" className={styles.searchLabel}>Enter the terms you wish to search for.</label>
          </div>
          <button className={styles.toggle + ' ' + styles.submitSearch}><span className={styles.materialIcons} aria-hidden="true">chevron_right</span><span className={styles.visuallyHidden}>Submit search</span></button>
